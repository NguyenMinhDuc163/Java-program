...
class Invoice {
    ...
    private int quantity, total, profit;
    ...
    public Invoice(int codeIvoice, Client client, MatHang matHang, int quantity) {
        ...
        this.profit = quantity * (matHang.getPriceOut() - matHang.getPriceIn());
    }
    ...
    public String toString(){
        return String.format("%s %s %s %s %d %d %d", codeIvoice, client.getName(), client.getAddress(),
                matHang.getName(), quantity, total, profit);
    }
}
